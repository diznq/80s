...
int crypto_rsa_sha1_verify_with_key(const void *key, const char *data, size_t data_size, const char *expected_signature, size_t expected_signature_size, const char **error);
int crypto_rsa_sha256_verify_with_key(const void *key, const char *data, size_t data_size, const char *expected_signature, size_t expected_signature_size, const char **error);

int crypto_private_key_new(const char *key, void **out_key, const char **error);
int crypto_private_key_from_buffer_new(const char *key_data, size_t key_data_size, void **out_key, const char **error);
int crypto_private_key_release(const void *key);

int crypto_public_key_new(const char *key, void **out_key, const char **error);
int crypto_public_key_from_buffer_new(const char *key_data, size_t key_data_size, void **out_key, const char **error);
